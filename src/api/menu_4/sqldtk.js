 ...
 * 
 */
let getBuildingByXmbh = function(page, size = 20,xmbh,ldxxZjjgzt=0){
    return requests8083.get("data-presale-funds/shiyong/getLdFundsList", { 
        current: page, size,xmbh,ldxxZjjgzt})
  }
...
let getSbInfo = function(ldbh,jgzh){
  return requests8083.get("data-presale-funds/shiyong/getTuikuanFrom", {ldbh,jgzh})
}
