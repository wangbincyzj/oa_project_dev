 ...
 * 修改密码
 */
let changPwd = function (userId, oldPass, userPass, userPassy, userType) {
  return requests.post("data_center/user/changePassword", {userId, oldPass, userPass, userPassy, userType})
}
