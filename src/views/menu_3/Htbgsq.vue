...
export default {
  ...
  methods: {
    fetchTableData() {
      yushouContractApi.getAllContract({htBazt: 2, kfsRwbh: this.$store.state.rwbh, htCxzt:-1,htMsrxm: this.msr, htMsrzjhm: this.zjh, htBah:this.bah}, this.currentPage, this.pageSize).then(ret => {
