  ...
  <div class="tjysmbItems">
      ...
      <ul>
        <li>1.根据第六条按照套内建筑面积计价的约定，双方同意按照下列原则处理：
          <ul class="ul2">
            ...
            <li>买受人解除合同的，应当书面通知出卖人。出卖人应当自解除合同通知送达之日起15日内退还买受人已付全部房款（含已付贷款部分），并自买受人付款之日起，按照 <input type="text"
                                                                                                  class="w50">
        ...
        <li> 3. 根据第六条按照套计价的，出卖人承诺在房屋平面图中标明详细尺寸，并约定误差范围。该商品房交付时，套型与设计图纸不一致或者相关尺寸超出约定的误差范围，双方约定如下:
          <p><input type="text" class="w800">。</p>
        </li>
        <li>4. 双方自行约定：
          <p><input type="text" class="w800">。</p>
        </li>
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>（三）买受人解除合同的，应当书面通知出卖人。出卖人应当自解除合同通知送达之日起15日内退还买受人已付全部房款（含已付贷款部分），并自买受人付款之日起，按照
          <input type="text" class="w50">%（不低于中国人民银行公布的同期贷款基准利率）计算给付利息；同时，出卖人按照全部房价款的
          <input type="text" class="w50">%向买受人支付违约金。买受人不解除合同的，有权要求出卖人赔偿由此造成的损失，双方约定如下：
      ...
      <ul>
        <li>
          ...
          <ul class="ul2">
            ...
            <li>2. 供热、采暖方式；</li>
            <li>3. <input type="text" class="w500"></li>
            <li>4. <input type="text" class="w500"></li>
      ...
      <ul>
        <li>（一）地基基础和主体结构
          ...
          <p>经检测不合格的，买受人有权解除合同。买受人解除合同的，应当书面通知出卖人。出卖人应当自解除合同通知送达之日起15日内退还买受人已付全部房款（含已付贷款部分），并自买受人付款之日起，按照
            <input type="text" class="w50">%（不低于中国人民银行公布的同期贷款基准利率） 计算给付利息。给买受人造成损失的，由出卖人支付
            <select name="" id="">
        ...
        <li>（二） 其他质量问题
          ...
          <ul class="ul2">
            ...
            <li>
              ...
              <input type="text" class="w50">%（不低于中国人民银行公布的同期贷款基准利率）计算给付利息。给买受人造成损失的，由出卖人承担相应赔偿责任。因此而发生的检测费用由出卖人承担。
              <div>买受人不解除合同的，<input type="text" class="w800">。</div>
            </li>
          </ul>
        </li>
        <li>（三）装饰装修及设备标准
          ...
          <p>不符合上述标准的，买受人有权要求出卖人按照下列第（1）、
            ...
            <input type="text" class="w50">方式处理（可多选）：</p>
          <ul class="ul2">
            <li>（1）及时更换、修理；</li>
            <li>（2）出卖人赔偿双倍的装饰、设备差价；</li>
            <li>（3）<input type="text" class="w800">；</li>
            <li>（4）<input type="text" class="w800">。
          ...
          <ul class="ul2">
            <li>
              <div> 1.该商品房室内空气质量符合
                ...
                标准，标准名称：
                <input type="text" class="w200">，标准文号：
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>（三）在保修期内，买受人要求维修的书面通知送达出卖人 <input type="text" class="w50">
    ...
    <div class="item">
      ...
      <p>出卖人不按照第十六条、第十七条约定承担相关责任的，由 <input type="text" class="w500">
        承担连带责任。</p>
      <p>关于质量担保的证明见附件八。</p>
    </div>
    ...
    <div class="item">
      ...
      <ul>
        <li>（一）出卖人应当自本合同签订之日起【<input type="text" class="w50">
          日内】（不超过30日）办理商品房预售合同登记备案手续，并将本合同登记备案情况告知买受人。
        </li>
        <li>（二）有关预售合同登记备案的其他约定如下：
          <ul class="ul2">
            <li><input type="text" class="w500">；</li>
            <li><input type="text" class="w500">。</li>
          </ul>
        </li>
      </ul>
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>（二）因出卖人的原因，买受人未能在该商品房交付之日起 <input type="text" class="w50">
          日内取得该商品房的房屋所有权证书的，双方同意按照下列第 <input type="text" class="w50">
          种方式处理：
          <ul class="ul2">
            <li>1. 买受人有权解除合同。买受人解除合同的，应当书面通知出卖人。出卖人应当自解除合同通知送达之日起15日内退还买受人已付全部房款（含已付贷款部分），并自买受人付款之日起，按照
              <input type="text" class="w50">%（不低于中国人民银行公布的同期贷款基准利率）计算给付利息。买受人不解除合同的，自买受人应当完成房屋所有权登记的期限届满之次日起至实际完成房屋所有权登记之日止，出卖人按日计算向买受人支付全部房价款万分之
              <input type="text" class="w50">的违约金。
            </li>
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>（三）物业服务期间，物业收费计费方式为【
          ...
          】【<input type="text" class="w100">】。物业服务费为 <input type="text" class="w50">元/月·平方米（建筑面积），另见附件九。
        </li>
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>（三）双方对其他配套设施约定如下：
          <ul class="ul2">
            <li>1.规划的车位、车库：<input type="text" class="w500">；</li>
            <li>2.会所：<input type="text" class="w500">；</li>
            <li>3.<input type="text" class="w800">。</li>
          </ul>
        </li>
      </ul>
    ...
    <div class="item">
      ...
      <p>双方应当按照国家的有关规定，向相应部门缴纳因该商品房买卖发生的税费。因预测面积与实测面积差异，导致买受人不能享受税收优惠政策而增加的税收负担，由
        <input type="text" class="w500">承担。</p>
    </div>
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>6. <input type="text" class="w800">。</li>
        <li>7. <input type="text" class="w800">。</li>
      </ul>
    </div>
    ...
    <div class="item">
      ...
      <p>
        ...
        方式送达对方。任何一方变更通讯地址、联系电话的，应在变更之日起 <input type="text" class="w50">
    ...
    <div class="item">
      ...
      <p>本合同在履行过程中发生的争议，由双方当事人协商解决，也可通过消费者协会等相关机构调解；或按照下列第<input type="text" class="w50">种方式解决：</p>
      <ul>
        <li>1.依法向房屋所在地人民法院起诉。</li>
        <li>2.提交 <input type="text" class="w500">仲裁委员会仲。</li>
      </ul>
    </div>
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>本合同及附件共
          <input type="text" class="w50">页，一式
          <input type="text" class="w50">份，其中出卖人
          <input type="text" class="w50">份， 买受人
          <input type="text" class="w50">份，
    ...
    <div class="item">
      ...
      <ul>
        ...
        <li>6. 电梯：
          <ul class="ul2">
            <li>（1） 品牌：<input type="text" class="w500">；</li>
            <li>（2） 型号：<input type="text" class="w500">；</li>
          </ul>
        </li>
        <li>7.管道：<input type="text" class="w500">。</li>
        <li>8.窗户：<input type="text" class="w500">。</li>
        <li>9.<input type="text" class="w800">。</li>
        <li>10.<input type="text" class="w800">。</li>
      </ul>
    </div>
    ...
    <div class="item">
      ...
      <ul>
        <li>（一） 保修项目、期限及责任的约定
          <ul class="ul2">
            <li>1. 地基基础和主体结构： 保修期限为：<input type="text" class="w50">（不得低于设计文件规定的该工程的合理使用年限）；
              <br><input type="text" class="w800">。
            </li>
            <li>2. 屋面防水工程、有防水要求的卫生间、房间和外墙面的防渗漏： 保修期限为：<input type="text" class="w50">（不得低于5年）；
              <br><input type="text" class="w800">。
            </li>
            <li>3. 供热、供冷系统和设备： 保修期限为：<input type="text" class="w50">（不得低于2个采暖期、供冷期）；
              <br><input type="text" class="w800">。
            </li>
            <li>4. 电气管线、给排水管道、设备安装： 保修期限为：<input type="text" class="w50">（不得低于2年）；
              <br><input type="text" class="w800">。
            </li>
            <li>5. 装修工程： 保修期限为：<input type="text" class="w50">（不得低于2年）；
              <br><input type="text" class="w800">。
            </li>
            <li>6. <input type="text" class="w800">；</li>
            <li>7. <input type="text" class="w800">；</li>
        ...
        <li>（二） 其他约定 <br>
          <textarea style="display:block;margin-left: 30px;margin-top: 10px; width: 60%; height: 100px"></textarea>
        </li>
      </ul>
    </div>
