    ...
    <div v-if="dialogType===1">
      ...
      >
        ...
        <el-form-item label="合同编号：">
            <el-input v-model="form.jiaocunXmbh" disabled></el-input>     
        </el-form-item>
        <el-form-item label="付款方式：">
            <el-input v-model="form.fkfs" disabled></el-input>      
        </el-form-item>
        <el-form-item label="购房总额：">
            <el-input v-model="form.gfze" disabled></el-input>     
        </el-form-item>
        <el-form-item label="首付金额：">
            <el-input v-model="form.sfje" disabled></el-input>       
        </el-form-item>
        <el-form-item label="购房人：">
            <el-input v-model="form.gfr" disabled></el-input>       
        </el-form-item>
        <el-form-item label="身份证号：">
            <el-input v-model="form.jiaocunMsrzjhm" disabled></el-input>         
        </el-form-item>
        <el-form-item label="监管银行：">
            <el-input v-model="form.jiaocunKhyh" disabled></el-input>         
        </el-form-item>
        <el-form-item label="监管账户：">
            <el-input v-model="form.jiaocunJkzh" disabled></el-input>
        </el-form-item>
...
export default {
    ...
    addData() {
      tjjgzjApi
        .addDeposit({
          ...
          jiaocunXmbh: this.$store.state.projectData.xmxxXmbh,
          jiaocunLdbh: "6028001",
          jiaocunFh: "602",
  ...
  created() {
    ...
    // console.log( this.$store.state.projectData.xmxxXmbh,'项目编号')
  }
};
</script>
