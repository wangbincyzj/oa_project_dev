...
export default {
  ...
  methods: {
    ...
    handleDetail(index,row) {
      ...
      console.log('合同列表ssss',this.contractData)
      this.innerVisible = true;
    },
    setMode(row) {
     this.depositData = row
     console.log('定金列表sss',this.depositData.djDgrzjhm)
    },
    relation(){
     //关联 
     fwdjglApi.relationData(
       this.depositData.djId,
       this.contractData.jiaocunHtbh,
     ).then(res=>{
         if(res.code == 200){
