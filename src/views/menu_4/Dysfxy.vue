  ...
  <div class="sqjgzh">
    <TitleTable title="账户对应监管协议列表">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="合同备案号" prop="htId"></el-table-column>
        <el-table-column label="银行名称" prop="companyName"></el-table-column>
        <el-table-column label="企业名称" prop="itemName"></el-table-column>
        <el-table-column label="监管账户" prop="ldName"></el-table-column>
        <el-table-column label="项目名称" prop="phone"></el-table-column>
        <el-table-column align="center" label="审核状态" prop="status"></el-table-column>
        <el-table-column align="center" label="审核时间" prop="status"></el-table-column>
