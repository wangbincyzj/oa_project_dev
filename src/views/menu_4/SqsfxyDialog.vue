<template>
  <div>
    <div v-if="dialogType===1">
      <el-form label-position="right" label-width="160px" size="mini" inline :model="form">
        <!-- 0添加 1编辑 2查看-->
    ...
    <div class="detail myForm-mb5 myDialog" v-loading="loading" v-if="dialogType===2">
      ...
      <!--//模式,0详情 1,修改-->
      <el-form label-position="right" label-width="160px" size="mini" inline :model="form1">
        <!-- 0添加 1编辑 2查看-->
        <el-form-item label="甲方(监管机构)">
          <el-input v-model="form.hetongJgjgmc"></el-input>
        </el-form-item>
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="收件名称" prop="companyName"></el-table-column>
        <el-table-column label="收件性质" prop="bank"></el-table-column>
        <el-table-column label="份数" prop="jgzhName"></el-table-column>
      </el-table>
      <h3 class="title">显示收件图片</h3>
      <el-form label-position="right" label-width="150px" size="mini" inline :model="form2">
        <!-- 0添加 1编辑 2查看-->
