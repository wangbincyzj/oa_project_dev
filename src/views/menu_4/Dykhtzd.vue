<template>
  <div class="sqjgzh">
    <TitleTable title="项目对应监管账户列表">
      <el-table :data="tableData" style="width: 100%" @cell-mouse-enter="cellMouseEnter">
        <el-table-column label="序号" type="index"></el-table-column>
        <el-table-column label="公司名称" prop="zjjgzhGsmc"></el-table-column>
        <el-table-column label="监管银行" prop="zjjgzhYhmc"></el-table-column>
        <el-table-column label="监管账户名称" prop="zjjgzhZhmc"></el-table-column>
        <el-table-column label="监管账号" prop="zjjgzhId"></el-table-column>
        <el-table-column align="center" label="开户日期" prop="zjjgzhAddtime"></el-table-column>
        <el-table-column align="center" label="流程" prop="zjjgzhLczt"></el-table-column>
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button size="mini" @click="handlePrint(scope.$index, scope.row)">打印通知单</el-button>
      ...
      >
        <DykhtzdDialog ref="dialog" :dialog-type="dialogType" @submitSuccess="submitSuccess" />
      </el-dialog>
    </TitleTable>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    fetchDataByxmId(id) {
      sqjgzhApi
        .getAccountById(this.currentPage, this.pageSize, id)
        .then(ret => {
          console.log(ret);
